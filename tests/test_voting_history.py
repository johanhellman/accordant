...
class TestVotingHistory:
    ...
    def test_record_votes(self, tenant_db_session):
        ...
        votes = (
            tenant_db_session.query(models.Vote).filter_by(conversation_id=conversation_id).all()
        )
    ...
    def test_record_votes_empty_rankings(self, tenant_db_session):
        ...
        count = (
            tenant_db_session.query(models.Vote)
            .filter_by(conversation_id="test-conv-empty")
            .count()
        )
        assert count == 0
