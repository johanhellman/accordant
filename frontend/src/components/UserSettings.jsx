      ...
      <div className="settings-section">
        ...
        <div className="privacy-actions">
          <div className="action-card">
            ...
            <p>
              Download a copy of all your data, including profile information and conversation
          ...
          <div className="action-card danger-zone">
            ...
            <p>
              Permanently delete your account and all associated conversations. This action cannot
              be undone.
            </p>

            {!confirmDelete ? (
              <button className="btn btn-danger action-btn" onClick={() => setConfirmDelete(true)}>
                <Trash2 size={16} />
                Delete Account
              </button>
            ) : (
