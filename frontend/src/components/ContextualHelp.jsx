    ...
    "stages",
    {
      ...
      content: (
        <>
          ...
          <ul>
            <li>
              <strong>Stage 1 (Consultation):</strong> Your query is sent to multiple AI
              Personalities. They answer independently.
            </li>
            <li>
              <strong>Stage 2 (Peer Review):</strong> The personalities critique and rank each
              other's answers based on accuracy and helpfulness.
            </li>
            <li>
              <strong>Stage 3 (Synthesis):</strong> The Chairman AI compiles the best parts of the
              top-ranked answers into a final response.
            </li>
          </ul>
        </>
      ),
    ...
    "evolution",
    {
      ...
      content: (
        <>
          ...
          <p>
            Use this to create specialized agents, e.g., combining a "Coder" and a "Teacher" to make
            a "Coding Tutor".
          </p>
        </>
      ),
    ...
    "ranking",
    {
      ...
      content: (
        <>
          ...
          <ul>
            <li>
              <strong>Win Rate:</strong> The percentage of times this personality's answer was
              ranked #1 by its peers in Stage 2.
            </li>
            <li>
              <strong>Average Rank:</strong> The average position (1st, 2nd, 3rd...) it achieves.
              Lower is better.
            </li>
            <li>
              <strong>Sessions:</strong> Total conversations participated in.
            </li>
          </ul>
...
export default function ContextualHelp({ topic, type = "icon" }) {
  ...
  const data = HELP_CONTENT.get(topic) || HELP_CONTENT.get("default");
      ...
      {isOpen && (
        <div className="help-modal-overlay" onClick={() => setIsOpen(false)}>
          <div className="help-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="help-modal-body">{data.content}</div>
            <div className="help-modal-footer">
              <a href="/help" className="help-full-link">
