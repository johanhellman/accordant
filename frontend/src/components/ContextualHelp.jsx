    ...
    content: (
      <>
        ...
        <ul>
          ...
          <li>
            <strong>Stage 2 (Peer Review):</strong> The personalities critique and rank each other's
            answers based on accuracy and helpfulness.
          </li>
          <li>
  ...
  evolution: {
    ...
    content: (
      <>
        ...
        <p>
          Use this to create specialized agents, e.g., combining a "Coder" and a "Teacher" to make a
          "Coding Tutor".
        </p>
      </>
    ),
  ...
  ranking: {
    ...
    content: (
      <>
        ...
        <ul>
          <li>
            <strong>Win Rate:</strong> The percentage of times this personality's answer was ranked
            #1 by its peers in Stage 2.
          </li>
          <li>
