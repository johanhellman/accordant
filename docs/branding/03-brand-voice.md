...
Accordant's voice reflects our core values: intelligent collaboration, transparent processes, and thoughtful synthesis. We speak with clarity, professionalism, and warmth—making complex concepts accessible without dumbing them down.
...
- Less conversational, more informative
...
**Example:**
> "Organizations using Accordant report 40% improvement in answer quality and depth compared to single-model approaches. The collaborative process ensures comprehensive analysis that considers multiple angles."
...
- **Focus on value**: Explain benefits clearly
- **Be inclusive**: Use accessible language
- **Stay positive**: Frame things constructively
...
- "AI-powered" (redundant—everything is AI)
- "Leverage" (jargon, use "use" instead)
- "Synergy" (buzzword)
- "Disruptive" (overused)
...
- **Don't patronize**: Respect user intelligence
- **Don't hide limitations**: Be transparent about what Accordant can and can't do
- **Don't use clichés**: Find fresh ways to express ideas
...
**Example:**
> "We couldn't process your request. Please check your API key and try again. If the problem persists, contact support."
...
**Example:**
> "Great! Your council is ready. Start asking questions to see multiple AI personalities collaborate on your challenges."
...
When writing copy, ensure:

- [ ] Uses clear, accessible language
- [ ] Emphasizes collaboration and multiple perspectives
- [ ] Explains processes transparently
...
- [ ] Matches the appropriate tone for context
- [ ] Reflects Accordant's brand personality
...
- Refine based on user research and feedback

---

## Next Steps

1. Review voice guidelines with content team
2. Create copy templates for common patterns
3. Develop style guide for specific contexts
4. Train team members on brand voice
5. Create voice examples library
6. Establish review process for brand voice compliance
